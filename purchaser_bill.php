       ...
       <!-- left column -->
        ...
        <div class="card card-info">
            <div class="card-header">
              <h3 class="card-title">Purchaser Billing</h3>
            </div>
            <div class="card-body">
                <div class="row">
                <div class="col-md-4">
                <div class="form-group">
                 <label>Purchaser Accounts</label>
                 <select id="usernames" name="username" class="form-control select2">
                    <option>select name</option>
                 <?php

                  $s = mysqli_query($con,"select * from account where status='purchaser'")or die("Error");
              ...
              <div class="form-group">
                ...
                <input type="hidden" name="accountype" id="acounttype" value="purchase">
            </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
